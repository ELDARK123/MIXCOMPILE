...
#include "Obfuscation/PassDecider.h" //目的是用于根据程序特征和策略冲突情况来选择混淆组合
...
static cl::opt<bool> s_obf_pd("pd",cl::init(false),cl::desc("decide how to obfuscate"));
...
#include "PassRegistry.def"
  ...
  this->registerOptimizerLastEPCallback(
      [](llvm::ModulePassManager &MPM,
		...
		MPM.addPass(PassDecider(s_obf_pd)); // 根据程序特征来选择不同的混淆策略组合
